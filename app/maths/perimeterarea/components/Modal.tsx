...
export default function Modal({
  ...
  const sections = question.stepContent
    ? Array.from(
        { length: Math.ceil(question.stepContent.length / sectionSize) },
        (_, i) =>
          question.stepContent.slice(
            i * sectionSize,
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      <div
        ...
        className="absolute bg-white w-[600px] p-6 rounded-2xl shadow-2xl border-2 border-gray-300 pointer-events-auto"
      >
              ...
              <div className="max-h-[420px] overflow-y-auto pr-2 space-y-4 text-black font-bold text-lg">
                ...
                {sections[sectionIndex].map((step: any, index:number) => {
                  ...
                  return (
                    ...
                    >
                      <p className="mb-2 whitespace-pre-line">{step.text}</p>
